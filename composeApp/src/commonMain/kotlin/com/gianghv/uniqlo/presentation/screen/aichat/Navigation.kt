...
import com.gianghv.uniqlo.presentation.component.ChildSection
import com.gianghv.uniqlo.presentation.component.ParentSection
        ...
        Box(
            ...
            NavigationBar {
                NavigationBarItem(
                    ...
                    icon = {
                        Icon(
                            imageVector = if (selected == 0) Icons.Default.Menu else Icons.Outlined.Menu,
                ...
                NavigationBarItem(
                    ...
                    icon = {
                        Icon(
                            imageVector = if (selected == 1) Icons.Default.AccountBox else Icons.Outlined.AccountBox,
                            contentDescription = null
                        )
                    },
                    label = { Text("Pets") }
...
fun NavigationDrawerContent() {
    Column(
        ...
        NavigationDrawerItem(
            ...
            icon = {
                Icon(
                    imageVector = if (selected == 0) Icons.Default.Edit else Icons.Outlined.Edit,
                    contentDescription = null
                )
            },
            label = { Text("Inbox") }
        ...
        NavigationDrawerItem(
            ...
            icon = {
                Icon(
                    imageVector = if (selected == 4) Icons.Default.FavoriteBorder else Icons.Default.FavoriteBorder,
                    contentDescription = null
                )
            },
            label = { Text("Family") }
        ...
        NavigationDrawerItem(
            ...
            icon = {
                Icon(
                    imageVector = if (selected == 5) Icons.Default.Favorite else Icons.Default.Favorite,
                    contentDescription = null
                )
            },
            label = { Text("School") }
        ...
        NavigationDrawerItem(
            ...
            icon = {
                Icon(
                    imageVector = if (selected == 6) Icons.Default.Favorite else Icons.Default.Favorite,
                    contentDescription = null
                )
            },
            label = { Text("Work") }
            ...
            Surface(
                ...
                NavigationRail(
                    ...
                    NavigationRailItem(
                        ...
                        icon = {
                            Icon(
                                imageVector = if (selected == 0) Icons.Default.Favorite else Icons.Outlined.Favorite,
                                contentDescription = null
                            )
                        },
                        label = { Text("Inbox") }
